    ...
    <div class="flex flex-wrap">
        <div class="w-full lg:w-full my-6 pr-0 lg:pr-2">
            ...
            <div class="leading-loose">
                <form class="p-10 bg-white rounded shadow-xl" method="post" action="{{route('products.store')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="">
                        <label class="block text-sm text-gray-600" for="name">Name</label>
                        <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="name" name="name" type="text"
                               required="" placeholder="Product Name" aria-label="Name">
                    </div>
                    <div class="mt-2">
                        <label class="block text-sm text-gray-600" for="email">Price</label>
                        <input class="w-full px-5  py-1 text-gray-700 bg-gray-200 rounded" id="price" name="price" type="text" required="" placeholder="Product Price" aria-label="Price">
                    </div>
                    ...
                    <div class="">
                        ...
                        <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="name" name="image" type="file"
                               required="" placeholder="Product Image" aria-label="Name">
                    </div>
